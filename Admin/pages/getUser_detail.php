...
<td><input type="text" id="emp_fname" name="emp_fname" style="font-family:Prompt;" value="'.$fname.'" class="form-control" readonly></td>
</tr>
<tr style="text-align: center;">
<td style="text-align: center; font-family:Prompt;"><b>สกุล</b></td>
<td><input type="text" id="emp_lname" name="emp_lname" style="font-family:Prompt;" value="'.$lname.'" class="form-control" readonly></td>
</tr>
<tr>
<td style="text-align: center; font-family:Prompt"><b>ตำเเหน่ง</b></td>
<td><input type="text" id="emp_position" name="emp_position" style="font-family:Prompt;" value="'.$position.'" class="form-control" readonly></td>
</tr>
<tr>
<td style="text-align: center; font-family:Prompt"><b>โทรศัพท์</b></td>
<td><input type="text" id="emp_tel" name="emp_tel" style="font-family:Prompt;" value="'.$tel.'" class="form-control" readonly></td>
<tr>
<td style="text-align: center; font-family:Prompt""><b>อีเมล์</b></td>
<td><input type="text" id="emp_mail" name="emp_mail" style="font-family:Prompt;" value="'.$mail.'" class="form-control" readonly></td>
</tr>

<tr>
<td style="text-align: center; font-family:Prompt"><b>Username</b></td>
<td><input type="text" id="emp_user" name="emp_user" style="font-family:Prompt;" value="'.$user.'" class="form-control" readonly></td>
</tr>
<tr>
<td style="text-align: center; font-family:Prompt"><b>Password</b></td>
<td><input type="password" id="emp_pass" name="emp_pass" style="font-family:Prompt;" value="'.$pass.'" class="form-control" readonly></td>
</tr>
<tr>
