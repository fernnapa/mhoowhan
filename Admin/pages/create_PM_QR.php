     ...
     ?>
        <div class="modal fade" tabindex="-1" role="dialog" id="ModalDep">
                ...
                <br>           
                    ...
                    <tr>
                    <td style="width:50%"><input type="submit" name="submitAdd" id="submit" value="บันทึกข้อมูล" form="Add_PM" class="btn btn-success btn-block"></td>
                            ...
                            success:function(data){
                                ...
                                if(data == 1){
                                             swal( {
                                                    ...
                                                    location.href = "indexPM_phone.php";
                                                    }
                                                    );
                                }if(data == 2){
                                             swal( {
