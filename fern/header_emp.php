...
<div class="header">
  ...
  <a href="index_emp.php" class="w3-bar-item w3-button w3-teal w3-hover-teal"><img src="img/logo11.png" alt=""></a>
  <a href="logout.php" class="w3-bar-item w3-button w3-hide-small w3-right w3-right w3-hover-red w3-hover-text-white w3-teal" title="ออกจากระบบ">LOGOUT&nbsp;&nbsp;<i class="fa fa-sign-in"></i></a>
  ...
  <a href="index_emp.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white w3-hover-text-teal w3-right">HOME</a>

</div>
</div>
  <!-- Navbar on small screens -->
  <div id="navDemo" class="w3-bar-block w3-theme-d1 w3-hide w3-hide-large w3-hide-medium w3-white">
    <a href="index_emp.php" class="w3-bar-item w3-button w3-text-teal ">HOME</a>
    ...
    <a href="logout.php" class="w3-bar-item w3-button  w3-text-red">LOGOUT&nbsp;&nbsp;<i class="fa fa-sign-in"></i></a>
  </div>
</div>
</body>
</html>
