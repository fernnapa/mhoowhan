...
<div class="header">
  ...
  <a href="index_admin.php" class="w3-bar-item w3-button w3-teal w3-hover-teal"><img src="img/logo11.png" alt=""></a>
  ...
  <div id="navDemo" class="w3-bar-block w3-theme-d1 w3-hide w3-hide-large w3-hide-medium w3-white">
    <a href="index_admin.php" class="w3-bar-item w3-button w3-text-teal ">HOME</a>
