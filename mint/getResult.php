...
<table style="width:100%" align="center" border="1" class="table-bordered" >
    ...
    <td ><input type="text" name="pm_empno" id="pm_empno" value="'.$pm_note.'" readonly style="cursor: not-allowed; border: none;" ></td> 
    </tr>
    <tr>
    <td style="text-align: right;"><b>สถานะ </b></td>
    <td ><select name="pm_status" id="pm_status" style="width: 99%" class="form-control">
    <option value="3">ยืม-คืน</option>
    <option value="1">รอจัดสรร</option>
    </select></td> 
    </tr>
    </table>
    </div>
