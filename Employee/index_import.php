...
<body>
    ...
    <table align="center" border="0">
        ...
        <tr>            
            <th style="font-weight: normal; text-align:center; font-size: 14px" width="30%"><b>ไฟล์ข้อมูล CSV :</b></th>
        ...
        <tr><th><br/></th></tr>
        <tr>
            <th style="font-weight: normal; text-align:center; font-size: 14px" width="30%"><b> วันที่นำเข้า : </b> </th>
        ...
        <tr>
            <th style="font-weight: normal; text-align:center; font-size: 14px" width="30%"><b> รหัสพนักงานนำเข้า : </b></th>
    ...
    <div class="container">
        <div class="table-responsive" style="font-family:Prompt;"> 
            <table id="eq_data" class="table table-striped table-bordered">
                            <thead>
                                <tr>
	
	                                <th style="text-align:center; font-family:Prompt;">Bar Code</th>
	                                <th style="text-align:center; font-family:Prompt;">รายการ</th>
	                                <th style="text-align:center; font-family:Prompt;">Serial Number.</th>
                                    <th style="text-align:center; font-family:Prompt;">TOR</th>			 
