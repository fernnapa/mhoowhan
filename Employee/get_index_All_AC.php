    ...
    if(isset($_GET['id'])){
        ...
        $id = $_GET['id'];
                            ...
                            WHERE ac_id = $id";
                                        ...
                                        <table id="tableshow" style="width:100%; text-align: center; font-family:Prompt;" align="center" border="1" class="table table-hover table table-striped table-bordered " >
                                  ...
                                  <h4 align="center" style="font-family:Prompt; font-weight: bold;">รายการครุภัณฑ์ของศูนย์คอมพิวเตอร์</h4>  
                                    ...
                                    if($status == 7)
                                    {
                                        ...
                                        <table id="tableshow" style="width:100%; text-align: center; font-family:Prompt;" align="center" border="1" class="table table-hover table table-striped table-bordered " >
                                            ...
                                            <tr>
                                            <td style="text-align: center;"><b>พนักงานที่ทำรายการจัดสรร </b></td>
                                            <td style="text-align: left;" colspan="3">'.$emp_fname.'&nbsp;&nbsp;'.$emp_lname.'</td> 
                                            <input type="hidden" name="ac_hd_position" id="ac_hd_position" value="'.$ac_hd_position.'" >
                                            </tr>
                                        </table>
                                        </div>
