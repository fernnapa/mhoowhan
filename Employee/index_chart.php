           ...
           <div class="table-responsive" style="font-family:Prompt;">
                   <table>
                    <h3 align="center" style="font-family:Prompt;">การจัดการครุภัณฑ์ของศูนย์คอมพิวเตอร์</h3> 
                         <div align="center">
                            <div id="piechart" style=" font-family:Prompt;"></div>  
                        </div>  
                        <hr/>
                        <div align="center">
                        <div id="chart-container" style="width: 550px; height: 350px; font-family:Prompt;"><canvas id="graphCanvas"></canvas></div>
                        </div>
