...
<div class="card">
        ...
        <div class="table-responsive" align="center" style="font-family:Prompt;">
          ...
          <?php 
            ...
            WHERE `dep_no` = '$depid' ";
             ...
             if($num_rows>0)
             { ?>
              <table border="1" style="width:100%" class="table-bordered table-striped table-primary">
              <tr>
      ...
      <?php  }
          if(isset($_POST['search'] ) && $_POST['address'] == "all")
          {
            ...
            header('Location: index_map.php?address='.$address);
        ...
        <div class="table-responsive" align="center" style="font-family:Prompt;">
          ...
          <?php 
            ...
            WHERE `dep_no` = '$depid' ";
             ...
             if($num_rows>0)
             { ?>
              <table border="1" style="width:100%" class="table-bordered table-striped table-Light">
              <tr>
                <th colspan="5" bgcolor="#6495ED" ><font color="#FFFFFF" >&nbsp;ครุภัณฑ์จัดสรร</font></th>
              </tr>
              <tr>
              <th style="text-align: center;width:20%" class="table-primary">Barcode</th>
              <th style="text-align: center;width:20%" class="table-primary">Serial</th>
              <th style="text-align: center;width:20%" class="table-primary">ประเภท</th>
              <th style="text-align: center;width:30%" class="table-primary">ชื่อพนักงาน</th>
  
              </tr>
              <?php  while($data = mysqli_fetch_array($result))
              { ?>
              <tr>
              <td style="text-align: center;" class="table-light"><?php echo $data["ald_eq_barcode"]; ?></td>
              <td style="text-align: center;" class="table-light"><?php echo $data["ald_eq_serial"]; ?></td>
              <td style="text-align: center;" class="table-light"><?php echo $data["ald_type_name"]; ?></td>
              <td style="text-align: center;" class="table-light"><?php echo $data["ac_name"]; ?></td>
              </tr>
              <?php } ?>
              </table>
            ...
            { ?>
              ...
              <tr>
              <td style="text-align: center;" colspan="5" class="table-light"><font color="#FF3333"; size="2px;" ><b>หน่วยงานนี้ไม่มีรายการจัดสรรครุภัณฑ์</b></font></td>
              </tr>
              </table>
            <?php }
            ...
            WHERE `dep_no` = '$depid' ";
             ...
             <table border="1" style="width:100%" class="table-bordered table-striped table-Light">
              ...
              { ?>
              <tr>
              <td style="text-align: center;" class="table-light"><?php echo $data2["pmd_eq_barcode"]; ?></td>
              <td style="text-align: center;" class="table-light"><?php echo $data2["pmd_eq_serial"]; ?></td>
              <td style="text-align: center;" class="table-light"><?php echo $data2["pmd_type_name"]; ?></td>
              <td style="text-align: center;" class="table-light"><?php echo $data2["pm_username"]; ?></td>
              ...
              <tr>
              <td style="text-align: center;" colspan="5" class="table-light" ><font color="#FF3333"; size="2px;" ><b>หน่วยงานนี้ไม่มีรายการยืมครุภัณฑ์</b></font></td>
              </tr>
              </table>
               <?php } ?>
              </table>
